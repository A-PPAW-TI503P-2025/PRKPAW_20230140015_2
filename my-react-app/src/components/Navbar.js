        ...
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-4 py-5 space-y-3">
            <div className="flex items-center space-x-3 pb-4 border-b border-gray-200">
              ...
              <div>
                <p className="font-semibold text-gray-800">{user.nama || user.name}</p>
                <p className="text-sm text-gray-500 capitalize">{user.role}</p>
              </div>
            </div>

            <Link to="/dashboard" onClick={() => setMobileMenuOpen(false)} className="block px-6 py-3 rounded-full font-medium">
              Dashboard
            </Link>
            ...
            <button onClick={handleLogout} className="w-full flex items-center justify-center space-x-2 bg-red-500 hover:bg-red-600 text-white py-3 rounded-full font-medium mt-4">
